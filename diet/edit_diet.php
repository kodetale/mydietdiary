  ...
  <div class="diary">
    <form action="../diet/edit_diet_process.php" method="post" name="editform" id="edit_form" class="form" onsubmit="return edit_check()">
      ...
      ?>
        ...
        <p><input type="text" name="food[]" id="text" value="<?=$array['food']?>" required> <input type="text" name="kcal[]" id="num" pattern="^[0-9]*" value="<?=$array['kcal']?>" required> kcal <input type='button' class='minus_btn' onclick='remove(this)'></p>
